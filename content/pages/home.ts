export const homeContent = {
  ...
  stats: {
    ...
    statCard: {
      ...
      description: "We are proudly generating leads in over 40 states 🇺🇸",
    },
  },
  pricing: {
    badge: {
    ...
    subheading:
      "No need to spend thousands upfront, you only pay per lead.",
    card: {
      title: "Pricing Model",
      subtitle: "Only pay per qualified lead",
      price: "75.00",
      priceSymbol: "$",
      ctaText: "Book Call",
      ctaLink: "#",
      includes:
        "We charge the card on file after lead delivery.",
      features: [
        {
          title: "Benefits",
          items: [
            "No setup fees or contracts",
            "Pause & unpause leads anytime",
            "Free replacements for bad leads",
  ...
  faq: {
    ...
    subheading: "Everything you need to know about our lead generation service.",
    items: [
      {
      ...
      },
      {
        ...
        answer: "No contracts required. You only pay per lead, and you can pause or cancel your campaign anytime through our client portal. Scale up when you want more listings or pause when your pipeline is full — it’s completely flexible."
      },
      {
    ...
    items: [
      {
        ...
        description: "Get started with a quick demo call to see if our service is right for you.",
        points: [
          "Schedule a demo call with us",
          "Takes less than 15 minutes",
          "Quickly find out if this is for you",
        ],
        icon: "UserPlus",
      ...
      },
      {
        ...
        description: "Set up your lead generation campaign in just a few minutes.",
        points: [
          "Choose your target zip codes",
      ...
      },
      {
        version: "3.0",
        title: "Receive Leads",
        description: "Start receiving high-quality leads automatically delivered to you.",
        points: [
